...
const DetailPanel = ({ resource, loading, onClose }) => {
  const [panelWidth, setPanelWidth] = useState(window.innerWidth / 2); // 초기 50%
  ...
  return (
    <div 
      ref={panelRef}
      className="fixed inset-y-0 right-0 bg-white shadow-xl border-l border-gray-200 overflow-y-auto z-50 flex"
